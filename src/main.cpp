...
static void loadRoutine() {
  ...
  mq.push(StraightCmd(280.0f, 2.5f));
  right90();
  fwd500();

  left90();

  mq.push(StraightCmd(1000.0f, 3.5f));
  right90();
  fwd500();
  left90();
  fwd500();
  ...
  mq.push(StraightCmd(350.0f, 1.5f));
  mq.push(StraightCmd(-350.0f, 1.5f));
  left90();
  back500();
  left90();

  mq.push(StraightCmd(-2000.0f, 5.5f));

  left90();
  mq.push(StraightCmd(800.0f, 3.5f));

  right90();
  right90();

  mq.push(StraightCmd(300.0f, 2.0f));
  ...
  mq.push(StraightCmd(1350.0f, 3.5f));
  mq.push(StraightCmd(-350.0f, 1.2f));

  left90();
  fwd500();
  right90();

  mq.push(StraightCmd(570.0f, 2.5f));
